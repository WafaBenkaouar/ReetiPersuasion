...
public class DeviceSideRPC_Impl implements DeviceSideRPC.Iface {
	...
	ModeAttente_Reeti controler;

	DeviceClient device;

	public DeviceSideRPC_Impl(ModeAttente_Reeti controler) {
	...
	public void deviceConnected(Device dev) throws TException {
		...
		System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>     Device connection notification : " + dev);
	...
	public void deviceDisconnected(Device dev) throws TException {
		...
		System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>     Device disconnection notification : "
						+ dev);
